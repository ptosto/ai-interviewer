...
3) In a positive way, suggest areas the candidate may want to learn more about or develop skills in to further increase their value in an IT analyst role. Label the section "Areas for Growth".
4) Provide a specific rating of the candidate in terms of readiness for an entry-level IT analyst role referencing the "Core Skills and Knowledge for Entry-Level Systems Analysts" provided next. Give a summary along these lines: well prepared, strong candidate, has a foundation of knowledge to build on (for candidates who have several concepts correct but are lacking in several areas), needs to strengthen knowledge before being ready (for candidates who are not qualified). Do not assess answer structure (imagine the answers were given in conversation). Do not assess grammar and typographical errors. Do not expect that the candidate has real-world job experiences. Do not say the candidate is "well prepared" or a "strong candidate" if they are lacking in several areas. If they ended the interview without answering enough questions to provide an assessment, you can say so.
