...
4) Provide a specific rating of the candidate in terms of readiness for an entry-level IT analyst role referencing the "Core Skills and Knowledge for Entry-Level Systems Analysts" provided next. Give a summary along these lines: well prepared, strong candidate, has a foundation of knowledge to build on (for candidates who have several concepts correct but are lacking in several areas), needs to strengthen knowledge before being ready (for candidates who are not qualified). Do not assess answer structure (imagine the answers were given in conversation). Do not assess grammar and typographical errors. Do not expect that the candidate has real-world job experiences. Do not say the candidate is "well prepared" if they are lacking in several areas.
